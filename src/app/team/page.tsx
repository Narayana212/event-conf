  ...
  return (
    <MaxWidthWrapper className="pt-8 pb-8 w-screen">
      <main className="flex flex-col items-center gap-8 w-full md:flex-row">
        <section className="flex flex-col w-screen items-center justify-center space-y-4">
          <h1 className="text-5xl md:text-3xl  text-[#CD1739] font-semibold mb-4">
            OUR TEAM
          </h1>
          ...
          <div className="text-lg leading-relaxed">
            ...
            <p className="mb-2">
              <strong>Co-Convenors:</strong> Dr Shabana Mitra, Dr Ankur Mehra,
              Dr Ajit Kumar, Dr Balamurugan Balusamy
            </p>
            <p className="mb-2">
